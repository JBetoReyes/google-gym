...
const TRANSLATIONS = {
  es: {
    ...
    ex_names: {
      ...
      shoulder_press_maq: 'Máquina Press de Hombros',
  ...
  en: {
    ...
    ex_names: {
      ...
      shoulder_press_maq: 'Shoulder Press Machine',
  ...
  fr: {
    ...
    ex_names: {
      ...
      shoulder_press_maq: 'Machine Développé Épaules',
      skull_crusher: 'Skull Crusher',
...
const EXERCISE_CATALOG = [
  ...
  { id: 'shoulder_press_maq', name: 'Máquina Press de Hombros',    muscle: 'Hombro' },
  // Brazos - nuevos
...
function SortableReorderItem({ id, index, label }) {
  const { attributes, listeners, setNodeRef, transform, transition, isDragging } = useSortable({ id });
